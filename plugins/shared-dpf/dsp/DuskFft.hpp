...
// analysis core on it (docs/dpf-migration/10-spectrum-analyzer.md, step 1).
// Verbatim matters: Multi-Q's JUCE-vs-DPF A/B harness gates Match behaviour,
// so this move must not change a single arithmetic operation.
//
// This is deliberately NOT duskdpf::RealFFT (ui/DuskImGuiWidgets.hpp). That
