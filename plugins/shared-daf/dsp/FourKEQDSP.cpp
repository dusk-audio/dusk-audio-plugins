...
//
// DO NOT "FIX" THE DUPLICATED FINAL ANCHOR. Every non-constant array below ends
// with value[N-1] == value[N-2] (64 of 64 measured, against 3 of 64 for the
// value[N-2] == value[N-3] control). That is NOT an off-by-one in the emitter:
