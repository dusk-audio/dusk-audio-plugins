...
//
// MultiSynthPlugin.cpp — thin DAF shell around the framework-free MultiSynthDSP
...
protected:
             ...
             const MidiEvent* midiEvents, uint32_t midiEventCount) override
    {
        ...
        // lastBpm comes from bbt.beatsPerMinute, which the DAF header states only
...
private:
    ...
    // plain field store in DAF (Plugin::setLatency -> pData->latency = frames). No
    ...
    void handleMidi(const MidiEvent& ev) noexcept
    {
        ...
        // downstream callee to re-validate. DAF hands the host's bytes through
