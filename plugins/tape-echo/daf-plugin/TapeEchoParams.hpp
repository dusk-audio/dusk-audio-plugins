...
// legacySyncDivisionOverride in TapeEchoPlugin.cpp). Every DAF backend replays
...
// Per-parameter descriptor used by the UI: `id` is the DAF parameter symbol
...
static constexpr TeParam kTeParams[kParamCount] =
{
    ...
    // kParamBypass carries DAF's own designation symbol ("daf_bypass"), not this
